...
public class SlfptntVO implements Serializable{

	private String pbhtNo;
	private String slfptntNo;
	...
	public String getSlfptntNo() {
		return slfptntNo;
	}
	public void setSlfptntNo(String slfptntNo) {
		this.slfptntNo = slfptntNo;
	}
