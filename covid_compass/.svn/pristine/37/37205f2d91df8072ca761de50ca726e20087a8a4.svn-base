						...
						<!-- /.card-header -->
							<div class="card-body">
								...
								<div class="form-group" style="border: none; text-align: right;">
									<button onclick="location.href='notice-modifyForm'" class="btn btn-success" style="background: #1a4f72;">수정</button>
									<button class="btn btn-success" style="margin-left: 1%; background: #5bbc71;">삭제</button>
									<button class="btn btn-success" style="margin-left: 1%; background: #1a4f72;" onclick="CloseWindow()">목록</button>
								</div>
