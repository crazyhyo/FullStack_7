...
<body>
	...
	<div class="content-wrapper" style="background: #ffffff;">
		...
		<div style="clear:left; position: relative; left:27%; ">
			<strong>시도 및 시군구, 병원이름, 전화번호를 통합하여 검색합니다.</strong>
		</div>
		<div style="position: relative; left:24%;">
			<p style="color: #5e7ff7;">검색어 예시: <strong>'서울'</strong> 또는 <strong>'중구'</strong> 또는 <strong>'병원'</strong> 또는 <strong>'042'</strong>(전화번호 일부)</p>
		</div>
