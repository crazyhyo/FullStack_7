						...
						<div class="col-md-12">
							...
							<div class="card-body">
								...
								<div class="form-group" style="border: none; text-align: right;">
									<button class="btn" style="background-color: #5b6f90; color: white">등록</button>
									<button class="btn" style="margin-left: 1%; background-color: #5b6f90; color: white">리셋</button>
									<button class="btn" style="margin-left: 1%; background-color: #5b6f90; color: white">취소</button>
								</div>
