	...
	<div class="#">
		...
		<div class="#">
			...
			<div class="table-responsive">
				<table id="psti-list-table" class="table m-0" style="text-align: center;">
					<thead>
						<tr role="row">
					...
					<tbody>
						...
						<tr onclick="OpenWindow('psti-registform?pstiInnb=${pstiReadyListVO.pstiInnb}','','1200','750');" 
...
var dataSet = [
  [
	'<span class="badge badge-${pstiReadyListVO.sttusCode eq 'A101' ? 'info':'primary' }">${pstiReadyListVO.insttNm }검사소</span></td>',
    '${pstiReadyListVO.pstiNm }pstiNm',
	'<fmt:formatDate value="${pstiReadyListVO.wrtYmd }" pattern="yyyy-MM-dd" />2022-01-01',
    '${pstiReadyListVO.age }age',
    '<fmt:formatDate value="${pstiReadyListVO.birthDate }"pattern="yyyy-MM-dd" />1990-01-01',
    '${pstiReadyListVO.telNo }010-1234-4321',
   ]
];
// 컬럼명 입력받는 곳
var col_title = [
