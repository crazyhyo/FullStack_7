...
<body>
	...
	<div class="card-body">
		...
		<div class="row" style="margin-bottom: 7px;">
			...
			<div class="col-md-2">
			<button style="background-color: #5b6f90;border-color: #5b6f90;" type="button" class="btn btn-block btn-primary btn-sm">등록</button>
			</div>
			<div class="col-md-2">
			<button style="background-color: #5b6f90;border-color: #5b6f90;" type="button" class="btn btn-block btn-primary btn-sm">취소</button>
			</div>
		</div>
	</div>
</body>

아이디 비밀번호 이름 생년월일 주소 연락처 이메일 소속기관 소속번호
