			...
			<div class="card card-primary">
			  ...
			  <div class="card-body">
			    ...
			    <div class="row">
				    ...
				    <div class="col-md-2">
				   		<button type="button" class="btn btn-block btn-secondary" style="background-color: #5b6f90;">내 정보 수정</button>
				    </div>
				    <div class="col-md-2">
				   		<button type="button" class="btn btn-block btn-secondary" style="background-color: #5b6f90;">비밀번호 변경</button>
				    </div>
			    </div>
