			...
			<div class="card" style="margin-left: 10px;  margin-top: 1px;">
			  ...
			  <div id="" class="card-header d-flex p-0">
							...
							<li style="margin-right: 8px;">
								...
								<li class="nav-item">
								  <a onclick="deleteSearch()" class="nav-link active" style="background-color: #1a4f72;" id="custom-hspt-bookmark-list-tab" data-toggle="pill" href="#custom-hspt-bookmark-list" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true">연계기관</a>
								</li>
								<li class="nav-item">
