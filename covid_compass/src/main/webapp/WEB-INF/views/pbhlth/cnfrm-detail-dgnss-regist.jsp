		...
		<div class="row" style="margin: 1px;">
			<div class="col-lg-6 pl-0">
				<div class="card" style="margin-left: 10px; margin-top: 1px;">
					<div class="card-header" style="background-color: #1a4f72">
						<h3 class="card-title">
							<span style="color: white; font-size: 20px;">진료신청</span>
						</h3>
					</div>
					<div class="card-body">
							...
							<div id="placeSearch" class="col-md-7" style="visibility: hidden; height: 30px;">
								<div class="input-group float-right" style="width: 98%;">
									...
									<input id="keywordId" class="form-control" type="text" name="keyword" value="${pageMaker.cri.keyword }" style="width: 18%; display: inline-block;" /> <span class="input-group-append">
										<button id="searchBtn" class="btn btn-primary" type="button" style="background: #1a4f72; color: #ffffff; border-color: #5b6f90; display: inline-block; margin-bottom: 4px; margin-left: -7px;" data-card-widget="search" onclick="list_go('<%=request.getContextPath()%>/rest-pbht/hspt-bookmark-list', 1, '#hspt-all-list-table-tbody', '#inptnt-all-pagination-template', true);" data-url="<%=request.getContextPath()%>/rest-pbht/hspt-bookmark-list">
			...
			<div class="col-lg-6 pr-0">
				...
				<div class="row" style="height: 38px;padding-right: 2.8%;">
					...
					<div class="col-md-4">
						<button id="dgnssButton" type="button" style="background-color: #1a4f72; border-color: #1a4f72;" class="btn btn-block btn-primary " onclick="dgnssGo();">진료신청</button>
					</div>
					<div class="col-md-4">
