...
<div class="wrapper" style="max-width: 1280px; margin: 0 auto;">
			...
			<div class="card-header" style="background-color: #5bbc71;">
				<h3 class="card-title"><span style="color: white">시료 상세조회</span></h3>
			</div>
			<div style="margin-top: 30px;" class="col-3">
				<i class="fas fa-caret-right">&nbsp&nbsp검사결과 정보</i>
			</div>
			<div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="background-color: #f5f6f7; border-top: 2px solid black;" width="100px;"><strong>검사일자</strong></td>
                      <td style="border-top: 2px solid black;" width="300px;">2020/07/09 11:01:21</td>
			...
			<div style="margin: 0 auto;" class="col-1">
				<button type="button" class="btn btn-block btn-default" style="background-color: #5bbc71"><span style="color: white;">확정</span></button>
			</div>
			
			<div style="margin-top: 15px;" class="col-3">
				<i class="fas fa-caret-right">&nbsp&nbsp피검자정보</i>
			</div>
			<div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td style="background-color: #f5f6f7; border-top: 2px solid black;" width="100px;"><strong>성명</strong></td>
			...
			<div style="margin-top: 15px;" class="col-3">
				<i class="fas fa-caret-right">&nbsp&nbsp검사 요청기관</i>
			</div>
			<div class="card-body">
                <table class="table table-bordered">
                ...
                <div style="margin: 0 auto; " class="col-1">
					<button type="button" class="btn btn-block btn-default" onclick="history.go(-1)" style="background-color: #5bbc71"><span style="color: white;">취소</span></button>
				</div>
		</div>	
</div>
