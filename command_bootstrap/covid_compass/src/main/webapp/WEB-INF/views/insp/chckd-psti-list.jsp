	...
	<div class="#">
		<div class="card-header border-transparent"
			...
			<div class="row">
				...
				<p class="card-title" style="color: white; font-size: 30px;">피검자 목록</p>
				</div>
				<div class="col-sm-12 col-md-1">
					<a href="#" class="btn btn-info" style="font-size: 0.6rem;">시료요청</a>
				</div>
				<div class="col-sm-12 col-md-1">
					<a href="#" class="btn btn-info" style="font-size: 0.6rem;">엑셀다운로드</a>
				</div>
			</div>
				...
				<table class="table m-0" style="text-align: center;">
					...
					<tbody>
						...
						<tr>
							...
							<%-- <cㄴ:forEach items="${pstiReadyVOList }" var="pstiReadoVO"> --%>
							<%-- <c:set var="pstiReadyVO" value="" /> --%>
							<td>
								<div class="form-group">
									<div class="form-check">
