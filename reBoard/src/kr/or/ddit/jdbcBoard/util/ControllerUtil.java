...
public final class ControllerUtil {
  ...
  private static String prefix = "/WEB-INF/views/board/";
  private static String suffix = ".jsp";
  

  public static void forwardJSP(String fileName, HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
